...
class AccountFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.user = User("","", AdminData.getEmail())
    ...
    private fun update(updateUserRequest: UpdateUserRequest) {
        ...
        val call = retrofit.create(UserService::class.java).updateAccount(updateUserRequest = updateUserRequest, "Bearer " + AdminData.getToken(), AdminData.getId())
        call.enqueue(object : Callback<Void> {
            override fun onResponse(call: Call<Void>, message: Response<Void>) {
                if (message.code() == 200) {
                    ...
                    AdminData.setEmail(updateUserRequest.getEmail())
                }
